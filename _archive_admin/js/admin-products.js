/**
 * TUNIC FASHIONS - Admin Products Logic
                                ...
                                ${products.map(p => `
                                    <tr>
                                        <td class="product-cell d-flex align-items-center">
                                            <img src="${p.images?.[0] || '../assets/Logo/tunic_logo.png'}" style="width:40px;height:40px;object-fit:cover;border-radius:4px" class="me-3">
                                            <span>${p.name}</span>
                                        </td>
