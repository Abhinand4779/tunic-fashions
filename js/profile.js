/**
 * TUNIC FASHIONS - Profile & Auth Page Logic
    ...
    renderAuth() {
        ...
        wrap.innerHTML = `
            <div class="auth-container">
                ...
                : (this.isLogin ? 'Enter your credentials to access your account' : 'Join the TUNIC FASHIONS community and start your style journey')}
                        </p>
